  ...
  const sections: ReviewSection[] = [
    {
      ...
      fields: [
        ...
        { label: "Hissbeteckning", value: values.elevator_classification },
    ...
    },
    {
      ...
      fields: [
        ...
        { label: "Kollektiv", value: values.dispatch_mode },
        { label: "Korgstorlek", value: values.cab_size },
        { label: "Dagöppning", value: values.door_opening },
        { label: "Bärbeslag", value: values.door_carrier },

...
export function EmergencyPhoneSection({
  ...
  return (
    <div className="space-y-4">
      ...
      <EmergencyPhoneSummaryCards nodData={nodData} />
      <EmergencyPhoneDistrictTable nodData={nodData} />
    </div>
  );
}

function EmergencyPhoneSummaryCards({ nodData }: { nodData: NodData }) {
  return (
...
function EmergencyPhoneDistrictTable({ nodData }: { nodData: NodData }) {
  return (
    <Card>
      <CardHeader>

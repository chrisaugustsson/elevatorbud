...
export const ELEVATOR_EXPORT_COLUMNS: ExportColumn[] = [
  ...
  { key: "elevator_classification", label: "Hissbeteckning" },
  { key: "speed", label: "Hastighet" },
  { key: "lift_height", label: "Lyfthöjd" },
  { key: "load_capacity", label: "Marklast" },
  ...
  { key: "dispatch_mode", label: "Kollektiv" },
  { key: "cab_size", label: "Korgstorlek" },
  { key: "door_opening", label: "Dagöppning" },
  { key: "door_carrier", label: "Bärbeslag" },
  ...
  { key: "measures", label: "Åtgärder vid modernisering" },

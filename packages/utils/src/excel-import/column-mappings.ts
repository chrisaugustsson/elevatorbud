...
export const ELEVATOR_COLUMNS: ColumnDef[] = [
  ...
  { col: 4, letter: "E", field: "elevator_classification" },
  ...
  { col: 14, letter: "O", field: "dispatch_mode" },
  { col: 15, letter: "P", field: "cab_size", parser: "compound_cab_size" },
  { col: 16, letter: "Q", field: "door_opening", parser: "compound_door_opening" },
  { col: 17, letter: "R", field: "door_carrier" },
  ...
  { col: 31, letter: "AF", field: "measures" },
...
export const EMERGENCY_PHONE_COLUMNS = [
  ...
  { col: 3, letter: "D", field: "_elevator_classification" },

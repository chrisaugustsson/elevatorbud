...
export const ELEVATOR_COLUMNS: ColumnDef[] = [
  ...
  { col: 25, letter: "Z", field: "inspection_month", parser: "inspection_month" },
  ...
  { col: 29, letter: "AD", field: "recommended_modernization_year", parser: "recommended_modernization_year" },
